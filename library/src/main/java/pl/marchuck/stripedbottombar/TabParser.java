...
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.ACTIVE_COLOR;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.BADGE_BACKGROUND_COLOR;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.BADGE_HIDES_WHEN_ACTIVE;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.BAR_COLOR_WHEN_SELECTED;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.ICON;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.ID;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.INACTIVE_COLOR;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.IS_TITLELESS;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.STRIPE_COLOR;
import static pl.marchuck.stripedbottombar.TabParser.TabAttribute.TITLE;
...
class TabParser {
    ...
    @NonNull
    private final StripedBottomBarTab.Config defaultTabConfig;

    @NonNull
    private final XmlResourceParser parser;

    @Nullable
    private List<StripedBottomBarTab> tabs = null;

    TabParser(@NonNull Context context, @NonNull StripedBottomBarTab.Config defaultTabConfig, @XmlRes int tabsXmlResId) {
    ...
    @CheckResult
    @NonNull
    public List<StripedBottomBarTab> parseTabs() {
        if (tabs == null) {
            ...
            try {
                ...
                do {
                    ...
                    if (eventType == XmlResourceParser.START_TAG && TAB_TAG.equals(parser.getName())) {
                        StripedBottomBarTab stripedBottomBarTab = parseNewTab(parser, tabs.size());
                        tabs.add(stripedBottomBarTab);
                    }
    ...
    @NonNull
    private StripedBottomBarTab parseNewTab(@NonNull XmlResourceParser parser, @IntRange(from = 0) int containerPosition) {
        StripedBottomBarTab workingTab = tabWithDefaults();
    ...
    @NonNull
    private StripedBottomBarTab tabWithDefaults() {
        StripedBottomBarTab tab = new StripedBottomBarTab(context);
