 ...
 */
class StripedBottomBarBadge extends TextView {
    private int count;
    private boolean isVisible = false;

    StripedBottomBarBadge(Context context) {
        super(context);
    }
    ...
    void attachToTab(StripedBottomBarTab tab, int backgroundColor) {
    ...
    private void wrapTabAndBadgeInSameContainer(final StripedBottomBarTab tab) {
    ...
    void removeFromTab(StripedBottomBarTab tab) {
    ...
    void adjustPositionAndSize(StripedBottomBarTab tab) {
